...
| 019 | [zai-provider](019-zai-provider.md) | z.ai GLM adapter: limits-only authoritative quota overlay (`api_key_env` identity, session %/no-reset + weekly %/reset), honest idle usage | Active |
